...
public class VideoService {
    ...
    public List<Map<String,Object>> selectHistoricalVideo(long userId){
        return videoMapper.selectHistoricalVideo(userId);
    }
    //记录/更新观看进度，同一用户同一视频只保留一条，重复观看刷新时间和进度
    public Map<String,Object> recordHistory(long userId,long videoId,int progress) {
